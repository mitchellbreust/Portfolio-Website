...
function scroll_down(displacment_from_top_page) {
    ...
    if (displacment_from_top_page >=0 && displacment_from_top_page < screenHeight) {
        window.scrollTo({
            left: 0,
    ...
    else if (displacment_from_top_page >=  screenHeight * 1.1 && displacment_from_top_page < screenHeight * 2.2) {
        window.scrollTo({
            left: 0,
    ...
    else if (displacment_from_top_page >= screenHeight * 2.2 && displacment_from_top_page < screenHeight * 3.3) {
        window.scrollTo({
            left: 0,
...
function scroll_up(displacment_from_top_page) {
    screenHeight = screenHeightPixels();
    if (displacment_from_top_page >= screenHeight  * 1.1 && displacment_from_top_page < screenHeight * 2.2) {
        window.scrollTo({
            left: 0,
            top: 0,
            behavior: 'smooth'
    ...
    else if (displacment_from_top_page >= screenHeight * 3.2) {
        window.scrollTo({
            left: 0,
            top: screenHeight * 2.2,
            behavior: 'smooth'
